...
contract Ownable {
    ...
    event OwnerChanged(address _theOwner);
}
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(msg.sender == _tokenOwner[tokenId] ||  isApprovedForAll(_tokenOwner[tokenId], msg.sender), "Not approved to call this function");
...
contract RealEstateRMERC721Token is ERC721Metadata ("RMCapstone", "C", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/"){
